...
# test_2  - Test that something is returned for random request
def test_random_return():
    assert len(r_1_2.json())


# test_3  - Test that something found for each state
...
# test_4  - Test that valid amount breweries is found
...
# test_5  - Test that per_page and size return the same values
